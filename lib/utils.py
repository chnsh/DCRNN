...
def load_dataset(dataset_dir, batch_size, test_batch_size=None, **kwargs):
    ...
    test_dataset = TensorDataset(torch.FloatTensor(data['x_test']),
                                 torch.FloatTensor(data['y_test']))

    data['train_loader'] = DataLoader(train_dataset, batch_size, shuffle=True)
    data['val_loader'] = DataLoader(val_dataset, test_batch_size, shuffle=False)
    data['test_loader'] = DataLoader(test_dataset, test_batch_size, shuffle=False)
    # data['scaler'] = scaler
    return data
